export const portfolio = {
  ...
  "portfolio.overview.handle.title": "Total Value",
  ...
  "portfolio.overview.column.token": "Coin",
  "portfolio.overview.column.qty": "Total Balance",
  "portfolio.overview.column.indexPrice": "Index price",
  "portfolio.overview.column.assetValue": "USDC Value",
