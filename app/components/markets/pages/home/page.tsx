...
import { Box, cn, TabPanel, Tabs, useScreen } from "@/components/ui";
import { LeftNavProps, LeftNavUI } from "@/components/ui-scaffold";
import {
  MarketsProvider,
    ...
    <Box p={6}>
      <Tabs
        ...
        classNames={{
          ...
          tabsList: "oui-gap-4",
          trigger:
            "oui-bg-transparent oui-rounded-none oui-text-base-contrast-60 oui-border-b-2 oui-border-transparent " +
            "data-[state=active]:oui-text-primary data-[state=active]:oui-font-semibold " +
            "data-[state=active]:oui-border-primary data-[state=active]:after:oui-bg-transparent",
        }}
      >
        <TabPanel
