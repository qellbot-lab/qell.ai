...
import { cn, Flex, TabPanel, Tabs } from "@/components/ui";
    ...
    if (showVolume && showPnl) {
      return (
        <Tabs
          ...
          classNames={{
            tabsList: "oui-border-b-0",
            trigger:
              "oui-bg-transparent oui-text-base-contrast-60 data-[state=active]:!oui-text-white data-[state=active]:oui-font-bold data-[state=active]:oui-border-b-[2px] data-[state=active]:oui-border-white data-[state=active]:oui-pb-2",
          }}
        >
          <TabPanel
