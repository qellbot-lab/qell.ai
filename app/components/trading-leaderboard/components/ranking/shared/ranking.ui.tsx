...
export const Ranking: FC<RankingProps> = (props) => {
      ...
      <>
        <DataTable
          classNames={{
            ...
            header:"oui-bg-base-10 [&>th]:after:!oui-border-b-0 [&>th]:after:!oui-border-transparent",
            body: "oui-text-3xs oui-text-white",
            scroll: "oui-overflow-y-hidden oui-h-full oui-bg-transparent",
          }}
  ...
  return (
    <DataTable
      ...
      classNames={{
        root: cn(
          "oui-trading-leaderboard-ranking-table oui-bg-transparent",
          "!oui-h-[calc(100%_-_53px_-_8px)]",
        ),
        header: "oui-bg-base-10",
        body: "oui-text-xs oui-text-white",
        scroll: "oui-min-h-[600px] oui-max-h-[1250px] oui-bg-transparent",
      }}
      onRow={onRow}
      onCell={onCell}
    />
