...
const DesktopLayout: FC<{
  ...
  return (
    ...
    >
      ...
      >
        <FlagIcon size={iconSize} className="oui-fill-trade-loss" />
        <Text.numeral
          dp={quote_dp}
          color="lose"
          className="oui-underline oui-text-base oui-decoration-dashed oui-decoration-1 oui-underline-offset-4 "
        >
          {props.markPrice}
        </Text.numeral>
      </Flex>
...
const FlagIcon = (props: { size: number; className?: string }) => {
  return (
    <svg
      width={props.size}
      height={props.size}
      ...
      className={cn("oui-text-trade-loss", props.className)}
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
