...
import { AuthGuard } from "@/components/ui-connector";
import { LTVRiskTooltipWidget } from "@/components/ui-order-entry";
    ...
    >
      ...
      <Flex gap={1} itemAlign="center">
        ...
        <button onClick={onToggleVisibility}>
          {visible ? (
            <EyeIcon size={18} className="oui-text-base-contrast-36" />
          ) : (
            <EyeCloseIcon size={18} className="oui-text-base-contrast-36" />
          )}
        </button>
      </Flex>
    </Flex>
