...
import type { TabPanelProps } from "@/components/ui";
import { MobileOrderListWidget, TabType } from "@/components/ui-orders";
import {
  MobileLiquidationWidget,
  MobilePositionHistoryWidget,
  MobilePositionsWidget,
} from "@/components/ui-positions";
    ...
    <Flex direction={"column"} pb={2} width={"100%"}>
      ...
      <MobileOrderListWidget
        ...
        classNames={{
          ...
          cell: "oui-py-2  oui-p-2 oui-rounded-xl",
        }}
  ...
  return (
    <div className="oui-min-h-[300px]">
      <Tabs
        ...
        size="md"
        classNames={{ tabsList: " oui-rounded-t-xl oui-p-2" }}
      >
        <TabPanel
        ...
        >
          <MobilePositionHistoryWidget
            symbol={props.showAllSymbol ? undefined : props.symbol}
            onSymbolChange={props.onSymbolChange}
            classNames={{ cell: "oui-p-2 oui-rounded-xl" }}
            sharePnLConfig={props.sharePnLConfig}
          />
        </TabPanel>
        <TabPanel
...
export const DataList: React.FC<DataListState & { className?: string }> = (
  ...
  return (
    <Tabs
      ...
      classNames={{
        tabsList:
          "oui-border-b oui-border-line-6 oui-px-3 oui-overflow-x-scroll oui-hide-scrollbar",
        trigger:
          "data-[state=inactive]:!oui-text-base-contrast-60 data-[state=active]:!oui-text-white data-[state=active]:oui-font-medium data-[state=active]:!oui-border-b-2 data-[state=active]:!oui-border-white data-[state=active]:!oui-pb-2",
        tabsContent: "oui-bg-transparent",
      }}
    >
