...
export const MobileLayout: React.FC<TradingState> = (props) => {
    ...
    <SymbolInfoBarWidget
      ...
      trailing={
        ...
        >
          ...
          <Text.numeral
            suffix={<Text className="oui-text-base-contrast-80 ">&nbsp;USDC</Text>}
            dp={2}
  ...
  const topBar = (
    <Box intensity={900} className="oui-rounded-xl oui-bg-base-10" mx={1} px={3} py={2}>
      {symbolInfoBar}
      <SimpleSheet
    ...
    <div className="oui-relative oui-grid oui-gap-1 oui-bg-base-10">
      <main className="oui-hide-scrollbar oui-space-y-1 oui-overflow-y-auto">
        ...
        <React.Suspense fallback={null}>
          <LazyTopTabWidget className="oui-mx-1 oui-rounded-xl oui-bg-base-10" />
        </React.Suspense>
        <React.Suspense fallback={null}>
