  ...
  if (state.status <= AccountStatusEnum.NotConnected || disabled) {
    return (
      <Button
        ...
        angle={45}
        className="wallet-connect-button oui-text-white"
      ...
      >
        {isMobile ? t("connector.connectWallet") : t("connector.connectWallet")}
      </Button>
    );
    // return (
    //   <Tooltip
  ...
  return (
    <DropdownMenuRoot>
      <DropdownMenuTrigger asChild>
        ...
        >
          <Text.formatted rule="address" className="oui-text-white">
            {address}
          </Text.formatted>
        </Button>
      </DropdownMenuTrigger>
