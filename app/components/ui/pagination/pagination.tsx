...
const PaginationLink = ({
  ...
  <button
    ...
    className={buttonVariants({
      ...
      className:
        "oui-min-w-6 oui-rounded-full oui-text-primary-contrast oui-font-semibold data-[active=false]:hover:oui-bg-base-6 disabled:oui-bg-transparent disabled:hover:oui-bg-transparent",
      // size,
    })}
    {...props}
  />
